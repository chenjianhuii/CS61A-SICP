...
CREATE TABLE size_of_dogs AS
  ...
  WHERE height <= max and min < height;
...
INSERT INTO stacks_helper SELECT a.dogs || ', ' || b.dogs , a.last_height + b.last_height, b.last_height, 2
  FROM stacks_helper AS a, stacks_helper AS b
  WHERE a.last_height < b.last_height;

INSERT INTO stacks_helper SELECT a.dogs || ', ' || b.dogs , a.stack_height + b.stack_height, b.last_height, 3
  FROM stacks_helper AS a, stacks_helper AS b
  WHERE a.last_height < b.last_height and a.n = 2 and b.n = 1;

INSERT INTO stacks_helper SELECT a.dogs || ', ' || b.dogs , a.stack_height + b.stack_height, b.last_height, 4
  FROM stacks_helper AS a, stacks_helper AS b
  WHERE a.last_height < b.last_height and a.n = 3 and b.n = 1;
