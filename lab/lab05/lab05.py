...
def berry_finder(t):
    ...
    """
    "*** YOUR CODE HERE ***"
    # We don't need to check the recursive base by using branches() function
...
def add_trees(t1, t2):
    ...
    for i in range(len(ch1)):
        ch.append(add_trees(ch1[i], ch2[i]))
    for c in ch2[len(ch1):]:
        ch.append(c)
    return tree(label(t1)+label(t2), ch)
    # modified PKUFlyingPig's implement
