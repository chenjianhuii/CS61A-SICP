...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if not who:
            ...
            if feral_hogs and abs(last0-num_rolls) == 2:
                score0 += 3
            last0 = score
            score0 += score
            ...
            if feral_hogs and abs(last1-num_rolls) == 2:
                score1 += 3
            last1 = score
            score1 += score
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if who:
            return announce_highest(who, score1, max(running_high, gain))
        else:
            return announce_highest(who, score0, max(running_high, gain))
    return say
    # END PROBLEM 7
...
def make_averaged(original_function, trials_count=10000):
    ...
    def fun(*args):
        ...
        for _ in range(trials_count):
            acc += original_function(*args)
        return acc / trials_count
    return fun
    # END PROBLEM 8
